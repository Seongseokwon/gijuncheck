...
// 검색 결과 스니펫은 160자 안쪽에서 잘린다. 임의계속가입 신청기한 원문처럼
// 긴 규정 문구는 본문에서 다루고, 여기에는 판단에 필요한 숫자만 남긴다.
const DESCRIPTION =
  '피부양자 자격상실은 사유 발생일로부터 14일 이내 신고가 원칙이며, 늦으면 상실일로 소급해 지역보험료가 부과됩니다. ' +
  '상실 사유별 시점, 소급 부과를 줄이는 방법, 임의계속가입 신청기한까지 정리했습니다.';
...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a:
      '공단에 이의신청서와 소명자료를 제출할 수 있습니다. 소득이 실제로는 그만큼 발생하지 않았다면 소득 관련 증빙을, 소득이 줄었다면 조정 신청을 함께 검토하는 것이 좋습니다.',
  },
];
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: ldJson(
            guideJsonLd({
              ...
              faq: FAQ,
              published: PUBLISHED,
              modified: ROUTES.guideLosingEligibility.lastModified,
            }),
          ),
        }}
      />
      ...
      <article className="mx-auto max-w-3xl space-y-10 px-4 py-10 sm:py-14">
        ...
        <Section id="reduce" title="소급 부과를 줄이는 방법">
          ...
          <P>
            <strong>둘째, 퇴직·소득 감소 시에는 조정 신청을 검토합니다.</strong>{' '}
          ...
          <ToolCta
            ...
            description="지역가입자와 임의계속가입 중 어느 쪽의 보험료가 더 저렴한지 비교하고, 36개월 총 차액까지 보여줍니다."
          />
        </Section>
        ...
        <Section id="object" title="금액이 이상할 때 — 이의신청">
          ...
          <Ul>
            ...
            <li>소득이 줄었다면 조정 신청 서류를 함께 검토</li>
          </Ul>

          <Callout tone="info" title="먼저 금액이 맞는지 확인해 보세요">
