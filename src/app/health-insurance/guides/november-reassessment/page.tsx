...
const TOC: TocItem[] = [
  ...
  { id: 'adjust', label: '소득이 줄었다면 — 조정 신청' },
...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a:
      ...
      '지금 소득이 끊겼어도 과거 소득으로 계산되기 때문에 실제 상황과 차이가 생길 수 있습니다. 이 경우 조정 신청을 검토할 수 있습니다.',
  },
  {
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: ldJson(
            guideJsonLd({
              ...
              faq: FAQ,
              published: PUBLISHED,
              modified: ROUTES.guideNovemberReassessment.lastModified,
            }),
          ),
        }}
      />
      ...
      <article className="mx-auto max-w-3xl space-y-10 px-4 py-10 sm:py-14">
        ...
        <Section id="why" title="왜 11월인가">
          ...
          <Callout tone="info" title="시차를 이해하면 통보를 받아도 덜 당황합니다">
        ...
        <Section id="what" title="무엇이 바뀌는가">
          ...
          <Callout tone="warn" title="관련 통보가 집중되는 시기이기도 합니다">
        ...
        <Section id="notice" title="통보를 받으면 확인할 순서">
          ...
          <Ol>
            ...
            <li>
              <strong>금액이 이상하면 이의신청 또는 조정 신청을 합니다.</strong>
            </li>
          </Ol>

          <ToolCta
            routeKey="dependent"
            description="통보 내용이 맞는지 스스로 확인해 보세요. 금융소득 문턱과 재산 과세표준 구간을 반영해 판정하고 근거 조항을 보여줍니다."
          />
        </Section>

        <Section id="adjust" title="소득이 줄었다면 — 조정 신청">
          <P>
          ...
          <Callout tone="info" title="가만히 있으면 자동으로 조정되지 않습니다">
            ...
            계속 냅니다. 조정 신청은 신청해야 적용됩니다. 필요한 서류와 절차는
