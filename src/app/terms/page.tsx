  ...
  return (
    <article className="max-w-none space-y-6 text-sm leading-relaxed text-slate-700">
      ...
      <section className="space-y-2">
        ...
        <p>
          {SITE.name}은 건강보험 피부양자 자격, 지역가입자 보험료, 임의계속가입
          등에 관한 <strong>모의 판정 및 모의 계산</strong> 도구를 무료로
          제공합니다.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p>
          본 사이트는 관계 법령과 공공기관이 공표한 기준을 근거로 계산하며, 각
          결과 화면에 적용한 근거 조항과 기준 연도를 표시합니다.
        </p>
        <p>
          다만 법령과 요율은 수시로 개정되며, 개정 내용이 본 사이트에 반영되기까지
