 ...
 *
 * 2026-08-05 공단 지역보험료 모의계산 대표 사례 13건 재대조 완료.
 * 공단 화면은 사업·이자·배당·기타소득을 ‘사업소득 등’으로 합산 입력받으며,
 * 지역보험료에서는 금융소득을 별도 문턱 없이 전액 반영한다.
 */
...
/** 공단 모의계산과의 대조 검증 완료 여부. 2026-08-05 대표 사례 13건 대조 완료. */
